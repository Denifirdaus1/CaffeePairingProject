...
export const downloadPDF = async (data: PairingResponse, qrCodeUrl?: string, cafeName?: string) => {
    ...
    root.render(React.createElement(PrintableView, { data, qrCodeUrl, cafeName }));
